//代码生成时,文件路径: e:/download/securityinjava-ssm/src/main/java/orgauth/rmuser/util/IRmUserConstants.java
...
package org.quickbundle.orgauth.rmuser;
...
public interface IRmUserConstants extends IGlobalConstants {
    ...
    public final static String SQL_QUERY_ALL = "select RM_USER.ID, RM_USER.NAME, RM_USER.LOCK_STATUS, RM_USER.LOGIN_ID, RM_USER.AUTHEN_TYPE, RM_USER.ORGANIZATION_ID, RM_USER.EMPLOYEE_ID, RM_USER.EMAIL, RM_USER.ADMIN_TYPE, RM_USER.AGENT_STATUS, RM_USER.LOGIN_STATUS, RM_USER.LAST_LOGIN_DATE, RM_USER.LAST_LOGIN_IP, RM_USER.LOGIN_SUM, RM_USER.IS_AFFIX from RM_USER";
